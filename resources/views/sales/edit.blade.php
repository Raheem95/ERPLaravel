    ...
    <div class="maindiv">
        ...
        <div class = "row">
            ...
            <div class="form-group col-md-6">
                ...
                {!! Form::select('SalesAccountID', $SalesAccountsOptions, $SalesAccountID, [
                    'class' => 'input_style',
                    'id' => 'SalesAccountID',
                    'required' => 'required',
                ]) !!}
    ...
    <script>
        ...
        $(document).on('click', '.AddRow', function() {
            ...
            tr.append($(
                ...
                "' placeholder = 'ادخل الكمية' class = 'input_style CheckQTY Calculate' value = '0'></td>"
            ))
            tr.append($(
